...
@short_answer_bp.route('/teacher/course/<course_code>/short-answer/<int:short_answer_id>/ai-generate', methods=['GET'])
def teacher_short_answer_ai_generate(course_code, short_answer_id):
    """Page for AI-generating short answer questions"""
    if 'user_id' not in session:
        return redirect(url_for('auth.login'))
    ...
    return render_template('teacher_ai_generate.html', 
                         course=course, 
