...
def create_or_verify_data():
    with app.app_context():
        ...
        print(f"Found {len(existing_submissions)} existing submissions, need {num_students_to_add}")
        
        # Always create more submissions for demo purposes
        print(f"Creating additional submissions for demo...")
